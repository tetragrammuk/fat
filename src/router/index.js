		...
		children: [
		 {
		  ...
		  component: () => import('@/page/customerMsg/customerMsg'),
		 },
		 {
		  path: 'Setting',
		  name: '群眾推播',
		  ...
		  component: () => import('@/page/msgList/msgList'),
		 },
		 {
		  path: 'AutoReply',
		  name: '自動回覆',
		  ...
		  component: () => import('@/page/msgList/autoList'),
		 },
		 {
		  path: 'WelcomeSetting',
		  name: '歡迎訊息',
		  ...
		  component: () => import('@/page/msgList/welcomeList'),
		 }
		]
	   },
	{
		...
		children: [
		 {
			...
			component: () => import('@/page/tagsetting/tagsetting'),
		 }
		]
	},
	{
		...
		children: [
		 {
			...
			component: () => import('@/page/URLsetting/URLsetting'),
		 }
		]
	},
	{
		...
		children: [
		 {
			...
			component: () => import('@/page/chatroom/chatroom'),
		 }
		]
	},
